...
if (isset($_GET["id"])) {
    ...
    if (empty($errors)) {
        $success = $projectsManager->updateProject($id, $project);
...
<body>
    <h1>Modifie un projet</h1>
    <p><a href="index.php">Retour à l'accueil</a></p>
    <p>Utilise cette page pour modifier un nouvel animal de compagnie.</p>
    ...
    <form action="create.php" method="POST">
        ...
        <fieldset>
            ...
            <div>
                <input type="checkbox" id="development" name="category" value="development" <?php echo htmlspecialchars(implode(', ', $project['category'])) ? "checked" : ""; ?> />
                <label for="development">Développement</label>
            </div>

            <div>
                <input type="checkbox" id="finance" name="category" value="finance" <?php echo htmlspecialchars(implode(', ', $project['category'])) ? "checked" : ""; ?> />
                <label for="finance">Finances</label>
            </div>

            <div>
                <input type="checkbox" id="admin" name="category" value="admin" <?php echo htmlspecialchars(implode(', ', $project['category'])) ? "checked" : ""; ?> />
                <label for="admin">Administration</label>
            </div>

            <div>
                <input type="checkbox" id="marketing" name="category" value="marketing" <?php echo htmlspecialchars(implode(', ', $project['category'])) ? "checked" : ""; ?> />
